...
export default function VisualSchedule() {
  ...
  // Desktop view mode (booked_only vs full_grid)
  ...
  // 24-Hour Slots Grid for Desktop View
  ...
  return (
    <div className="pb-20 text-slate-800">
      {/* ========================================== */}
      {/* MOBILE VIEW (block lg:hidden) - Redesigned Bookings Directory with Separated Sections */}
      {/* ========================================== */}
      <div className="block lg:hidden space-y-5 max-w-md mx-auto px-4">
        ...
        {/* 5. Mobile Booking Cards Stack - 2 Separated Sections */}
